...
/** From iris.ts in other vscode plugin */

export type DeserializedRowData = Record<string, unknown> & {
  data: Record<string, unknown>;
};

export type SerializedRowData = Record<string, unknown> & {
  data: string;
};
...
export type EnterpriseDhType = dh & {
...
export interface IdeConnection extends QueryConnectable {
  serviceId: string;
...
export interface QueryInfo {
  ...
  saveWorkspaceData(
    ...
    workspaceStorageVersion: number
  ): Promise<void>;
}
